...
All the environments are registered in the `isaaclab3_Go2_Distill` extension. They start
...
import isaaclab3_Go2_Distill.tasks  # noqa: F401

# PLACEHOLDER: Extension template (do not remove this comment)
with contextlib.suppress(ImportError):
    import isaaclab3_Go2_Distill.tasks_experimental  # noqa: F401
...
def _format_presets(preset_map: dict | None) -> str:
    ...
    Args:
        preset_map: Mapping of :class:`~isaaclab3_Go2_Distill.utils.preset_target.PresetTarget`
    ...
    if preset_map is None:
        return "(unavailable)"
    from isaaclab3_Go2_Distill.utils.preset_target import PresetTarget
...
def main():
    """Print all environments registered in `isaaclab3_Go2_Distill` extension."""
    ...
    if args_cli.show_presets:
        from isaaclab3_Go2_Distill.utils.preset_cli import enumerate_task_presets
